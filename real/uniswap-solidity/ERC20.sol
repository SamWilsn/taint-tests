...
contract ERC20 {
  ...
  function increaseAllowance(address spender, uint256 addedValue) public returns (bool) {
    _approve(msg.sender, spender, add(_allowed[msg.sender][spender], addedValue));
    return true;
  }
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    _approve(msg.sender, spender, sub(_allowed[msg.sender][spender], subtractedValue));
    return true;
  }
  ...
  function _burnFrom(address account, uint256 value) internal {
    _burn(account, value);
    _approve(account, msg.sender, sub(_allowed[account][msg.sender], value));
  }
